...
stale_pattern='com\.example\.compose|ModalBottomSheetNavHost|bottomSheetFullScreen<|BottomSheetScope|dismissBottomSheet|SKAI does not currently distribute|SlideNavHost\(navController,|PlaceholderRouteKind\.(Sheet|FullScreen|Popover)|PlaceholderRouteKind\.entries'
