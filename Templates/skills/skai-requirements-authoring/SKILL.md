---
name: skai-requirements-authoring
description: Drafts behavioral requirements into a skai change package (mode inference, gated discussion with inline items, and typed requirement change items). Use when the user asks to write, backfill, or update product requirements.
---

# SKAI: Requirements authoring
